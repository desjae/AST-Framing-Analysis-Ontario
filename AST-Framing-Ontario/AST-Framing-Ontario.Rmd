...
library(text2vec) # Modern Text Mining Framework for R
library(textdata) # Download and Load Various Text Datasets
...
library(word2vec) # Distributed Representations of Words
library(wordcloud) # Word Clouds
library(ldatuning) # Tuning of the Latent Dirichlet Allocation Models Parameters
