...
```{r}
pdfLocation <- "Texts/Academic Papers NoRef"
...
NAwords <- c("school", "transportation", "can", "use", "active", "et", "al", "travel", "study", "elsevier", "na", "sciencedirect", "journal", "transport", "mode", "modes", "children", "the", "use", "n", "s", "schools", "also", "p", "b", "used", "number")
...
```{r}
#eval(parse(text = paste("NAwords", 1, sep = "")))
NAwords1
