...
In total, _X_ articles were accessed.
...
NAwords <- c("contact", "cancellations", "catholic", "waterloo", "board", "east", "transportation", "students", "student", "website", "tri", "can", "district", "will", "please", "may", "school", "https", "school", "schools", "walking", "cycling", "gta", "login", "and", "or", "the", "active", "asst", "stp")
...
Corpora will be cleaned for white spaces, punctuation, English stop words, and converted to lowercase. Any additional stop words will need to be removed manually as the user sees fit. 
```{r}
