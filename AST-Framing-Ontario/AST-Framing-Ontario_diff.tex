...
%DIF ADD AST-Framing-Ontario.tex      Fri May 26 10:38:03 2023
...
\begin{frontmatter}
  ...
  \title{\DIFdelbegin \DIFdel{How is }\DIFdelend \DIFaddbegin \DIFadd{Framing }\DIFaddend active school travel \DIFdelbegin \DIFdel{framed }\DIFdelend in Ontario, \DIFdelbegin \DIFdel{Canada?}\DIFdelend \DIFaddbegin \DIFadd{or how spinach is good
for you}\DIFaddend }
...
Montreal, Quebec, Canada H3T 1J4}
  ...
  stakeholders in }\DIFdelend \DIFaddbegin \DIFadd{is promoted in many jurisdictions,
  including }\DIFaddend Ontario, Canada\DIFdelbegin \DIFdel{through efforts such as }\DIFdelend \DIFaddbegin \DIFadd{, where there is provincial support for
  }\DIFaddend school travel planning \DIFdelbegin \DIFdel{. Education strategies like workshops or resources that
  ...
  used }\DIFdelend \DIFaddbegin \DIFadd{(STP) efforts. Two pillars of school travel
  ...
  }\DIFaddend natural language processing \DIFdelbegin \DIFdel{, including topic modelling, to examine how AST is framed in }\DIFdelend \DIFaddbegin \DIFadd{techniques applied to }\DIFaddend publicly available
  documents from Ontario stakeholders involved in school travel
  planning. We then \DIFdelbegin \DIFdel{compared }\DIFdelend \DIFaddbegin \DIFadd{compare }\DIFaddend the findings from these documents to a
  selection of \DIFaddbegin \DIFadd{academic }\DIFaddend studies on AST\DIFdelbegin \DIFdel{and
  explored similarities between the two. We found that AST is framed in two ways: i) as a health and environmental issue; and ii) as an
  accessible and feasible transport option for children and parents. The
  frames encourage children and parents to adopt ASTgiven its health
  ...
  academic research.
  While these frames present AST in a positive light, they may not encourage parents to view current household travel
  behaviours as unhealthy for their children or their community.
  Stakeholders promoting AST in Ontario should further problematize the decline of AST and challenge the norm of driving children to school}\DIFdelend . \DIFaddbegin \DIFadd{We conclude that framing of AST
...
\DIFdelbegin \DIFdel{health }\DIFdelend \DIFaddbegin \DIFadd{policy }\DIFaddend perspective, increasing active travel to school \DIFdelbegin \DIFdel{represents a
major
opportunity }\DIFdelend \DIFaddbegin \DIFadd{presents major
opportunities }\DIFaddend to improve children's health and wellbeing
...
evaluation \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{buliungSchoolTravelPlanning2011, langUnderstandingModalChoice2011}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{hinckson2018school}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .
...
important }\DIFaddend role in shaping public \DIFdelbegin \DIFdel{perception about AST to attract greater }\DIFdelend \DIFaddbegin \DIFadd{perceptions about AST by generating
frames that create meaning, and thus influence the degree of }\DIFaddend attention
and recognition \DIFdelbegin \DIFdel{as }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend a ``problem'' that needs to be addressed through
\DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend change or new policies.
...
we \DIFdelbegin \DIFdel{discuss a few potentially modifiable determinants }\DIFdelend \DIFaddbegin \DIFadd{focus on two key aspects }\DIFaddend that may be targeted \DIFdelbegin \DIFdel{for change through STP.
}\DIFdelend \DIFaddbegin \DIFadd{from a policy
perspective: built environmental factors and perceptions and behaviors
of parents.
}\DIFaddend 

\DIFdelbegin \DIFdel{Children's mode choice to school is strongly influenced by their
parents' travel behaviours and the complexity of their household's
travel needs \mbox{%DIFAUXCMD
\citep{buliungLivingJourneySchool2021}}\hspace{0pt}%DIFAUXCMD
, as well as daily
parental support \mbox{%DIFAUXCMD
\citep{mahDoesParentalSupport2017a}}\hspace{0pt}%DIFAUXCMD
. This indicates
that shifting parental perceptions and habits is important. Convenience
and inclement weather have been cited by parentsas barriers to AST
\mbox{%DIFAUXCMD
\citep{buliungSchoolTravelPlanning2011}}\hspace{0pt}%DIFAUXCMD
.
Parental perceptions of the
built or school environment \mbox{%DIFAUXCMD
...
%DIFDELCMD < %%%
\DIFdel{Distance }\DIFdelend \DIFaddbegin \DIFadd{The built environment is a key factor for physical planning, and in this
respect distance }\DIFaddend between home and school is \DIFaddbegin \DIFadd{the factor }\DIFaddend most negatively
associated with AST
...
\citep{mammenUnderstandingDriveEscort2012}\DIFdelbegin \DIFdel{, which highlights that the volume and speed of cars can be a concern or
deterrent for
AST. }\DIFdelend \DIFaddbegin \DIFadd{: ironically, concerns about
the dangers of traffic become a vicious cycle
\mbox{%DIFAUXCMD
\citep{rothmanSchoolEnvironmentStudent2017}}\hspace{0pt}%DIFAUXCMD
.
}\DIFaddend 
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{Secondly, research has found that parents are key decision-makers with
respect to children's mode of travel to school
\mbox{%DIFAUXCMD
\citep{rothmanAssociationsParentsPerception2015}}\hspace{0pt}%DIFAUXCMD
. Particularly, after
distance \mbox{%DIFAUXCMD
\citep{curtis2015built}}\hspace{0pt}%DIFAUXCMD
, parental perceptions of the built or
school environment, as well as of their children's skills, have been
found to be key in influencing mode choice to school
\mbox{%DIFAUXCMD
\citep{demeesterParentalPerceivedNeighborhood2014, panterAttitudesSocialSupport2010, mandic2020differences, mammenUnderstandingDriveEscort2012, faulknerWhatQuickestEasiest2010}}\hspace{0pt}%DIFAUXCMD
.
For example, \mbox{%DIFAUXCMD
\citet{ramanathanHappinessMotionEmotions2014a} }\hspace{0pt}%DIFAUXCMD
found that
...
household's travel needs \mbox{%DIFAUXCMD
\citep{buliungLivingJourneySchool2021}}\hspace{0pt}%DIFAUXCMD
, as well
as daily parental support \mbox{%DIFAUXCMD
\citep{mahDoesParentalSupport2017a}}\hspace{0pt}%DIFAUXCMD
. This
suggests that shifting parental perceptions and habits is important.
}\DIFaddend 

\DIFdelbegin \DIFdel{School }\DIFdelend \DIFaddbegin \hypertarget{stp-frames}{%
\section{School travel planning in Canada and relevance of
frames}\label{stp-frames}}

\DIFadd{AST has become a policy issue on the education and public health agendas
...
at the participating school through \DIFdelbegin \DIFdel{a range of activities }\DIFdelend \DIFaddbegin \DIFadd{four pillars }\DIFaddend consisting of
...
\DIFdelbegin \DIFdel{Following the first large-scale evaluation of STP as an intervention in Canada, AST rates increased and 14\% of parents reported a perceived
...
indicate its potential to encourage behaviour change and
adoption of
AST.
}\DIFdelend \DIFaddbegin \DIFadd{Of the 4Es, }{[}\DIFadd{E}{]}\DIFadd{ngineering targets the first set of factors discussed
in the preceding section (the built environment), whereas
}{[}\DIFadd{E}{]}\DIFadd{ducation and }{[}\DIFadd{E}{]}\DIFadd{ncouragement target perceptions.
}\DIFaddend 
...
important to shift parental attitudes and perceptions }\DIFdelend \DIFaddbegin \DIFadd{The relevance of policy frames with respect to education and
encouragement is highlighted by \mbox{%DIFAUXCMD
...
AST-related communications}\DIFaddend , \DIFdelbegin \DIFdel{given their
...
as the media or institutions, construct the narrative of a frame }\DIFdelend \DIFaddbegin \DIFadd{since the construction of frames }\DIFaddend for policy
positions or public issues \DIFdelbegin \DIFdel{in order to }\DIFdelend \DIFaddbegin \DIFadd{can }\DIFaddend activate or restrict a particular
...
(un)acceptable and why \mbox{%DIFAUXCMD
\citep{beland2014developing}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .

\DIFdelbegin \DIFdel{Since STP activities heavily focus on education or encouragement \mbox{%DIFAUXCMD
\citep{buliungSchoolTravelPlanning2011, mammenActiveSchoolTravel2014, buttazzoniSupportingActiveSchool2018}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{Given the role of education and encouragement in STP}\DIFaddend , it is important
\DIFdelbegin \DIFdel{that parents and communities are receptive to the goals
of STP \mbox{%DIFAUXCMD
\citep{buttazzoniSupportingActiveSchool2018}}\hspace{0pt}%DIFAUXCMD
. Parents }\DIFdelend \DIFaddbegin \DIFadd{for the issues to be effectively framed. In the past, parents }\DIFaddend have been
found to express \DIFdelbegin \DIFdel{different }\DIFdelend understandings, language, and perceptions \DIFdelbegin \DIFdel{than planners of how }\DIFdelend \DIFaddbegin \DIFadd{regarding the
influence of }\DIFaddend the built environment \DIFdelbegin \DIFdel{can influence school travel \mbox{%DIFAUXCMD
\citep{buliungLivingJourneySchool2021}}\hspace{0pt}%DIFAUXCMD
. This is also true when it comes
to
other factors like }\DIFdelend \DIFaddbegin \DIFadd{on school travel that markedly differ
...
encouraging more active travel \mbox{%DIFAUXCMD
\citep{buliungLivingJourneySchool2021}}\hspace{0pt}%DIFAUXCMD
.
Similarly mismatched understandings have been detected with respect to
factors like the }\DIFaddend convenience of different modes to school
...
support from key policy makers}\DIFdelend \DIFaddbegin \DIFadd{Framing is important, but not all frames are equally effective. Frames
can appeal to economic reasons, to science and logic, or to moral
obligation}\DIFaddend . For example, \DIFdelbegin \DIFdel{parents have been found to
...
\emph{safety} and \emph{traffic} as common words\DIFaddbegin \DIFadd{, }\DIFaddend which suggests that
these are common concerns\DIFdelbegin \DIFdel{for parents}\DIFdelend . The word \emph{physical} is present in each
corpus, but \DIFdelbegin \DIFdel{it's not clear what this refers to (e.g,
}\DIFdelend \DIFaddbegin \DIFadd{this could refers to }\DIFaddend \emph{physical activity} \DIFdelbegin \DIFdel{, }\DIFdelend or the
\emph{physical environment}\DIFdelbegin \DIFdel{)}\DIFdelend . Furthermore, documents from STP stakeholder
...
documents \DIFaddbegin \DIFadd{frequently }\DIFaddend include the words \emph{route} or \emph{routes}\DIFdelbegin \DIFdel{as frequent terms}\DIFdelend .
...
of consecutive words. \DIFaddbegin \DIFadd{The latter makes sense given the involvment of
...
mobility}, and \emph{urban form} are \DIFdelbegin \DIFdel{other frequent pairs of consecutive words}\DIFdelend \DIFaddbegin \DIFadd{examples of these factors}\DIFaddend . Academic
...
Finally, both \DIFdelbegin \DIFdel{AST frames present solutions to encourage }\DIFdelend \DIFaddbegin \DIFadd{frames present the benefits of }\DIFaddend AST. STP stakeholder groups
seem to be communicating that AST is a healthy and \DIFdelbegin \DIFdel{easy }\DIFdelend \DIFaddbegin \DIFadd{accessible }\DIFaddend option as
a result of \DIFdelbegin \DIFdel{policy changes (e.g., available resources for
...
\begin{quote}
\emph{\DIFadd{A way to make sure your child is safe while walking to school is
with a `walking school bus.' Here are some tips for a walking
schoolbus\ldots{[}tips}{]}\DIFadd{\ldots Have fun!}} \DIFadd{(City of Ottawa)
}\end{quote}
...
\DIFaddbegin \DIFadd{In Ontario, municipalities, school boards and transportation consortia
...
discuss AST. }\DIFaddend Interpretation of the text assisted by natural language
processing reveals that \DIFdelbegin \DIFdel{AST in Ontario is primarily framed }\DIFdelend \DIFaddbegin \DIFadd{when AST is discussed, the primary frame
...
framed tends to emphasize the benefits }\DIFaddend to \DIFdelbegin \DIFdel{parents as beneficial
to }\DIFdelend the health and wellbeing of
children and to \DIFdelbegin \DIFdel{environmental
sustainability}\DIFdelend \DIFaddbegin \DIFadd{the environment}\DIFaddend . The policy documents reflect the
...
or to reduce the frequency of risky \DIFdelbegin \DIFdel{behaviours }\DIFdelend \DIFaddbegin \DIFadd{behaviors }\DIFaddend from drivers around
...
encouraged to adopt new travel \DIFdelbegin \DIFdel{behaviours}\DIFdelend \DIFaddbegin \DIFadd{behaviors}\DIFaddend . STP stakeholder groups
...
Both frames present \DIFdelbegin \DIFdel{the AST issue }\DIFdelend \DIFaddbegin \DIFadd{AST }\DIFaddend in a positive light\DIFdelbegin \DIFdel{. Neither }\DIFdelend \DIFaddbegin \DIFadd{, by highlighting the
potential benefits. However, neither }\DIFaddend frame appears to explain why
...
policy makers. \DIFdelbegin \DIFdel{Communicating the potential
...
imperative for all. }\DIFdelend For example, parents who drive their children to school
...
their own \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend contributes to the problem that is perceived to
...
\citep{collinsSafeJourneysEnterprising2001, rothmanSchoolEnvironmentStudent2017}}\hspace{0pt}%DIFAUXCMD
.
...
\DIFadd{Further, behavior change is mainly presented as an option for some but
...
}\DIFaddend Reynard et al. \citeyearpar{reynardGrowthResilienceHow2021}\DIFdelbegin \DIFdel{similarly }\DIFdelend \DIFaddbegin \DIFadd{, who }\DIFaddend found
in their analysis of Canadian municipal documents that one of the
dominant frames \DIFdelbegin \DIFdel{presented the adoption of behaviours to }\DIFdelend \DIFaddbegin \DIFadd{was to present behaviors that }\DIFaddend help mitigate the climate
crisis as \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{an individual }\DIFaddend choice but not ``the expected norm''\DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{, or what
society approves of, i.e., an injunctive norm
\mbox{%DIFAUXCMD
\citep{lapinski2005explication}}\hspace{0pt}%DIFAUXCMD
. In this case, a stronger case of
...
AST align with different levels of the SEM}\DIFdelend \DIFaddbegin \DIFadd{reinforce some of the same ideas}\DIFaddend : 1) \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend change from households
...
choice to school. However, \DIFdelbegin \DIFdel{it is beyond the scope of this paper to assess whether the proposed solutions are perceived to be
sufficient by
parents for increasing AST}\DIFdelend \DIFaddbegin \DIFadd{these measures tend to support the desired
...
going to school \mbox{%DIFAUXCMD
\citep{waygood2020japan}}\hspace{0pt}%DIFAUXCMD
.
}

\DIFadd{As well as what is }\emph{\DIFadd{in}} \DIFadd{the frame, it is also interesting to look
for what is }\emph{\DIFadd{not}} \DIFadd{there. The conservative orientation of the frames
...
imperative for change \mbox{%DIFAUXCMD
...
merits urgent behaviour change. A negative framing that challenges the social norm of driving could be more motivational to shift transport
modes, which would be
...
the strongest tools of government action }{[}\DIFadd{compared to, say, regulation
and transfers; see \mbox{%DIFAUXCMD
\citet{ohare1989typology}{]}}\hspace{0pt}%DIFAUXCMD
. The conservative
...
of }\DIFaddend household determinants of AST\DIFdelbegin \DIFdel{in the two frames that needs to be addressed. For example, }\DIFdelend \DIFaddbegin \DIFadd{. There was little discussion of
...
\mbox{%DIFAUXCMD
\citep{rothmanDeclineActiveSchool2018}}\hspace{0pt}%DIFAUXCMD
. Similarly, there was no
discussion about }\DIFaddend the role of convenience and inclement weather in
...
how }\DIFdelend \DIFaddbegin \hypertarget{conclusion}{%
\section{Conclusion}\label{conclusion}}

\DIFadd{In this paper we examined how AST is framed in Ontario. Our analysis was
...
investigation into how }\DIFaddend parents or the general public respond to messages
...
most encourage \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend change or increase political support for
...
%DIFDELCMD < %%%
\DIFdel{A }\DIFdelend \DIFaddbegin \DIFadd{It is pertinent at this point to note that a }\DIFaddend limitation of this study is
...
%DIFDELCMD < %%%
\DIFdel{In this paper we examined how AST is framed in Ontario. Our analysis was
supported by the use of natural language processing techniques, and reavealed that STP stakeholders frame AST as an accessible and feasible
way to travel to school that is valuable to children's health and to the environment. STP stakeholders are communicating that this issue can be addressed through household behaviour change and policy solutions.
Policy documents reveal that STP stakeholders are focusing on ``modifiable factors'' such as parental perceptions or micro-scale
...
should increase in local communities and how the
negative effects of
nonactive modes to school may impact children's health andwellbeing}\DIFdelend \DIFaddbegin \DIFadd{Finally, we would like to close with a brief note on the methodology.
...
data to check and/or expand the analysis presented here}\DIFaddend .
